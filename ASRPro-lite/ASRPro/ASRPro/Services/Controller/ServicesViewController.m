...
-(void)setLandScapeOrientationView{
    ...
    [self.mServicesPackageTableViewController_.view setFrame:CGRectMake(0, 45, 300, 598)];
    ...
    [mRecommendedServicesTableViewController_.view setFrame:CGRectMake(324, 350, 690, 350)];
...
- (void)showSearchBar {
    UISearchBar *lSearchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 0, 300, 35)];
