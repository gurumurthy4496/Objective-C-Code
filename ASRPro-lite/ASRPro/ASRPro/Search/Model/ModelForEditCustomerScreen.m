...
- (void)setValues:(NSMutableDictionary*)aCustomerDictionary {
    ...
    [mAppDelegate_.mModelForSearchScreen_ setMAppointmentNumber_:[aCustomerDictionary objectForKey:@"Number"]!=nil ?[NSString stringWithFormat:@"%@",[aCustomerDictionary objectForKey:@"Number"]]:@""];
    [mAppDelegate_.mModelForSearchScreen_ setMAdvisorID_:[aCustomerDictionary objectForKey:@"AdvisorID"]!=nil ?[NSString stringWithFormat:@"%@",[aCustomerDictionary objectForKey:@"AdvisorID"]]:@""];
    ...
    self.mEmail_=[aCustomerDictionary objectForKey:@"Email"]!=nil?[NSString stringWithFormat:@"%@",[aCustomerDictionary objectForKey:@"Email"]]:@"test@test.com";
    ...
    self.mCountry_=[aCustomerDictionary objectForKey:@"Country"]!=nil ?[NSString stringWithFormat:@"%@",[aCustomerDictionary objectForKey:@"Country"]]:@"India";
