...
-(void)addButtonToView{
    UIButton* lInspectionGreenButton=[[UIButton alloc]initWithFrame:CGRectMake(10, 5, 30, 30)];
    ...
    UIButton* lInspectionYellowButton=[[UIButton alloc]initWithFrame:CGRectMake(45, 5, 30, 30)];
    ...
    UIButton* lInspectionRedButton=[[UIButton alloc]initWithFrame:CGRectMake(80, 5, 30, 30)];
