...
-(void)addRecommendedServicesCell{
    ...
    //Approve Button
    UIButton* lTempApproveButton = [[UIButton alloc] initWithFrame:CGRectMake(xPos, 10, APPROVE_BUTTON_WIDTH_OPENRO, 20)];
    ...
    xPos+=(APPROVE_BUTTON_WIDTH_OPENRO+5);
    [lCellView bringSubviewToFront:mApproveButton_];

    //Decline Button
    UIButton* lTempDeclineButton = [[UIButton alloc] initWithFrame:CGRectMake(xPos, 10, DECLINE_BUTTON_WIDTH_OPENRO, 20)];
    ...
    xPos+=(DECLINE_BUTTON_WIDTH_OPENRO+5);
  ...
  [[GenericFiles genericFiles] createUIButtonInstance:lTempDoneButton buttonTitle:@"Undone" buttonTitleColor:[UIColor whiteColor] buttonTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] controlState:UIControlStateNormal buttoncontentEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0) buttoncontentHorizontalAlignment:UIControlContentHorizontalAlignmentCenter buttonBackgroundImage:kUNDONE_IMAGE];
    ...
    //Service Label
    UILabel* lTempServiceLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos, 10,SERVICE_LABEL_WIDTH_OPENRO, 20)];
    ...
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempHrsLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"%@ Hrs",[mServiceDictionary_ objectForKey:KHOURS]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    //Labor Label
    UILabel* lTempLaborLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos, 10, LABOR_LABEL_WIDTH_OPENRO,20)];
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempLaborLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"$%.2f",[[mServiceDictionary_ objectForKey:KPRICELABOR] floatValue]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    //Parts Label
    UILabel* lTempPartsLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos,10,PARTS_LABEL_WIDTH_OPENRO, 20)];
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempPartsLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"$%.2f",[[mServiceDictionary_ objectForKey:KPRICEPARTS] floatValue]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    // Price Label
    UILabel* lTempPriceLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos, 10, PRICE_LABEL_WIDTH_OPENRO,20)];
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempPriceLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"$%.2f",[[mServiceDictionary_ objectForKey:KPRICE] floatValue]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    // Edit Buton
    UIButton* lTempEditButton = [[UIButton alloc] initWithFrame:CGRectMake(xPos+5, 10, EDIT_BUTTON_WIDTH_OPENRO, 20)];
...
-(void)addCurrentServicesCell{
    ...
    //Service Label
    UILabel* lTempServiceLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos, 0,SERVICE_LABEL_WIDTH_OPENRO+50, self.contentView.frame.size.height)];
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempServiceLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"%@",[mServiceDictionary_ objectForKey:KSERVICENAME]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentLeft labelBackgroundColor:[UIColor clearColor]];
    [self setMServiceNameLabel_:lTempServiceLabel];
    [mServiceNameLabel_ setTag:SERVICE_LABEL_TAG_OPENRO];
    [lCellView addSubview:mServiceNameLabel_];
    xPos+=(SERVICE_LABEL_WIDTH_OPENRO+SEPERATION_GAP_OPENRO+50);
    ...
    //Labor Label
    UILabel* lTempLaborLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos, 0, LABOR_LABEL_WIDTH_OPENRO, self.contentView.frame.size.height)];
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempLaborLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"$%.2f",[[mServiceDictionary_ objectForKey:KPRICELABOR] floatValue]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    [self setMLaborLabel_:lTempLaborLabel];
    [mLaborLabel_ setTag:LABOR_LABEL_TAG_OPENRO];
    [lCellView addSubview:mLaborLabel_];
    ...
    //Parts Label
    UILabel* lTempPartsLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos, 0,PARTS_LABEL_WIDTH_OPENRO, self.contentView.frame.size.height)];
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempPartsLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"$%.2f",[[mServiceDictionary_ objectForKey:KPRICEPARTS] floatValue]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    [self setMPartsLabel_:lTempPartsLabel];
    [mPartsLabel_ setTag:PARTS_LABEL_TAG_OPENRO];
    [lCellView addSubview:mPartsLabel_];
    ...
    //Price Label
    UILabel* lTempPriceLabel=[[UILabel alloc] initWithFrame:CGRectMake(xPos, 0, PRICE_LABEL_WIDTH_OPENRO, self.contentView.frame.size.height)];
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempPriceLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"$%.2f",[[mServiceDictionary_ objectForKey:KPRICE] floatValue]] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    [self setMPriceLabel_:lTempPriceLabel];
    [mPriceLabel_ setTag:PRICE_LABEL_TAG_OPENRO];
    [lCellView addSubview:mPriceLabel_];
    ...
    //Edit Buton
    UIButton* lTempEditButton = [[UIButton alloc] initWithFrame:CGRectMake(xPos+5, 15, EDIT_BUTTON_WIDTH_OPENRO, 20)];
    [lTempEditButton addTarget:self action:@selector(isEditButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
    [[GenericFiles genericFiles] createUIButtonInstance:lTempEditButton buttonTitle:@"" buttonTitleColor:[UIColor whiteColor] buttonTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] controlState:UIControlStateNormal buttoncontentEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 0) buttoncontentHorizontalAlignment:UIControlContentHorizontalAlignmentCenter buttonBackgroundImage:kEDIT_IMAGE_RECOMMENDED];
    [self setMEditButton_:lTempEditButton];
    [mEditButton_ setTag:EDIT_BUTTON_TAG_OPENRO];
...
-(void)isEditButtonClicked:(UIButton*)aSender{
    ...
    [mAppDelegate_.mSearchViewController_.mOpenROServicesTableViewController_  pushToAddServicesView];
...
-(void)isApproveButtonClicked:(UIButton*)aSender{
    if([mAppDelegate_.mModelForSplashScreen_.mEmployeeType_ isEqualToString:@"Advisor"]){
            ...
            if(mDoneButton_.isSelected&&(([mAppDelegate_.mOpenRoServiceDataGetter_.mPartStatusID_ intValue]==1)||([mAppDelegate_.mOpenRoServiceDataGetter_.mPartStatusID_ intValue]==5))&&([[NSString stringWithFormat:@"%@",[mServiceDictionary_ objectForKey:@"Hours"]]floatValue]>0)){
...
-(void)isCellSwipedRight:(BOOL)isTrue{
    if(!isCellSwipedRight){
        if((mAppDelegate_.mModelForVehicleHistoryTableView_.mCurrentMode_!=1)&&(mAppDelegate_.mModelForVehicleHistoryTableView_.mCurrentMode_!=7)){
...
-(void)isCellSwipedLeft:(BOOL)isTrue{
    if(!isCellSwipedLeft){
        if(([mAppDelegate_.mModelForSplashScreen_.mEmployeeType_ isEqualToString:@"Technician"]&&([[NSString stringWithFormat:@"%@",[mServiceDictionary_ objectForKey:@"CreateUserID"]] intValue]==[mAppDelegate_.mModelForSplashScreen_.mEmployeeID_ intValue])&&(mAppDelegate_.mModelForVehicleHistoryTableView_.mCurrentMode_!=7))||([mAppDelegate_.mModelForSplashScreen_.mEmployeeType_ isEqualToString:@"Advisor"]&&([[NSString stringWithFormat:@"%@",[mServiceDictionary_ objectForKey:@"CreateUserID"]] intValue]==[mAppDelegate_.mModelForSplashScreen_.mEmployeeID_ intValue])&&(mAppDelegate_.mModelForVehicleHistoryTableView_.mCurrentMode_!=7))||(([mAppDelegate_.mModelForSplashScreen_.mEmployeeType_ isEqualToString:@"Advisor"]&&((mAppDelegate_.mModelForVehicleHistoryTableView_.mCurrentMode_==4)||(mAppDelegate_.mModelForVehicleHistoryTableView_.mCurrentMode_==6))))){
            if((!isPrimary)&&((!mApproveButton_.isSelected)&&(!mDeclineButton_.isSelected)))
