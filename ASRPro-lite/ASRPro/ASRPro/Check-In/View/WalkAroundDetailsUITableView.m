...
- (void)populateFormsSectionWithIndexPath:(NSIndexPath*)indexPath
    ...
    UIImage *damageImage = [UIImage imageNamed:[NSString stringWithFormat:@"%@Green",self.mvehicleDamageName_]];
    ...
    [lLeftImageView setFrame:CGRectMake(lXCoord, lYCoord, damageImage.size.width, damageImage.size.height)];
