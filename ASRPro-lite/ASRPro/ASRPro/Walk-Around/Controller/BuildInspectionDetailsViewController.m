...
- (void)setBorderAndColorsForBuildInspectionDetailsView {
    ...
    bottomBorderForHeadingView.frame = CGRectMake(self.view.frame.origin.x, 30, self.view.frame.size.width, 1);
...
didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    NSData* pictureData = UIImageJPEGRepresentation(image, 1.00f);
...
- (void)populateFormsSectionWithIndexPath:(NSIndexPath*)indexPath
    ...
    if (tabelView == self.mDamageTypesTableView_) {
        ...
        UIImageView *lImageView_ = (UIImageView*)[tableViewCell viewWithTag:2];
         lImageView_.frame = CGRectMake(lXCoord + 80, 2, 59, 34);
        [lImageView_ setHighlightedImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@Selected.png",[[mDamageTableArray_ objectAtIndex:0] objectAtIndex:indexPath.row]]]];
        [lImageView_ setImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@.png",[[mDamageTableArray_ objectAtIndex:0] objectAtIndex:indexPath.row]]]];
