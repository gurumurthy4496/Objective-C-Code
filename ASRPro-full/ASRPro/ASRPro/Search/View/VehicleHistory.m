...
#define kCustomerROInfoTableViewRowHeight 50
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    height = tableView.rowHeight+[self methodForReturnExpandedViewServicesArray:[[mAppDelegate_.mSearchDataGetter_.mVehicleHistoryData_ objectAtIndex:indexPath.row] objectForKey:@"RepairOrderLines"] view:nil].frame.size.height;
    return height+5;
}
...
- (void)populateFormsSectionWithIndexPath:(NSIndexPath*)indexPath
    ...
    DLog(@"Today Date : %@", lTodayDateStr);
    UILabel *lRONumberLbl = (UILabel*)[tableViewCell.contentView viewWithTag:1];
    lRONumberLbl.frame = CGRectMake(12, 18, 150, 18);
    lRONumberLbl.font = [UIFont regularFontOfSize:14.0f fontKey:kFontNameHelveticaNeueKey];
    ...
    lDateLbl.font = [UIFont regularFontOfSize:14.0f fontKey:kFontNameHelveticaNeueKey];
    ...
    lView = [self methodForReturnExpandedViewServicesArray:[[mAppDelegate_.mSearchDataGetter_.mVehicleHistoryData_ objectAtIndex:indexPath.row] objectForKey:@"RepairOrderLines"] view:lView];
...
- (UIView *)methodForReturnExpandedViewServicesArray:(NSArray *)aServicesArray view:(UIView *)aExpandView {
    ...
    if (aServicesArray != nil) {
        ...
        [aServicesArray enumerateObjectsUsingBlock:^(id object, NSUInteger index, BOOL *stop) {
            ...
            if ([[object objectForKey:@"Declined"] boolValue] == TRUE) {
                [lServiceNameLabel setText:[NSString stringWithFormat:@"Declined Line : %@ - %@",([[object objectForKey:@"PayTypeCode"] objectForKey:@"Code"] !=nil)?[[object objectForKey:@"PayTypeCode"] objectForKey:@"Code"]:@"",[object objectForKey:@"ServiceName"]]];
                [lServiceNameLabel setTextColor:[UIColor redColor]];
                [lServiceNameLabel setHighlightedTextColor:[UIColor redColor]];
            }else {
                [lServiceNameLabel setText:[NSString stringWithFormat:@"Line : %@ - %@",([[object objectForKey:@"PayTypeCode"] objectForKey:@"Code"] !=nil)?[[object objectForKey:@"PayTypeCode"] objectForKey:@"Code"]:@"",[object objectForKey:@"ServiceName"]]];
