...
/*
 * mBeginCheckInSearchData_ is used to hold all the Searched Customer List Data
 */
@property (retain, nonatomic) NSMutableDictionary *mBeginCheckInSearchData_;
/*
 * mAdvancedSearchData_ is used to hold all the Searched Customer List Data
 */
@property (retain, nonatomic) NSMutableDictionary *mAdvancedSearchData_;
/*
