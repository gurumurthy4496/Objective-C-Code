...
@class PreROEstimatePopupViewController;
...
@property (retain, nonatomic) ModelForBarCode *modelForBarCode;
...
@property (strong, nonatomic) PreROEstimatePopupViewController *mPreROEstimatePopupViewController_;
@property (strong, nonatomic) BuildInspectionDetailsViewController *buildInspectionDetailsViewController;
@property (strong, nonatomic) BarcodeViewController *barcodeViewController;
@property (strong, nonatomic) ZBarReaderViewController *zBarReaderViewController;
...
@property (retain, nonatomic) NSString *isCustomHeaderViewFullOrLight;
//@property (retain, nonatomic) NSString *isCustomHeaderViewFullOrLight;
@end
