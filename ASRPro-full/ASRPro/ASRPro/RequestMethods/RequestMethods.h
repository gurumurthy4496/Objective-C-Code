...
/**
 * Method used to get list of Appointments
 */
...
/**
 * Method used to get request for Service Lines
 * @param aRONumber for  RONumber
 */
...
/**
 * Method used to get request for OpenRO Service Lines
 * @param aRONumber for  RONumber
 */
-(void)getListofOpenROServices:(NSString*)aRONumber;

/**
 * Method used to put request for Complete Inspection
 * @param aRONumber for  RONumber
 */
