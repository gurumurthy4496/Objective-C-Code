...
- (void)getAppointmentList {
    mAppDelegate_.mWebEngine_.mWebMethodName_=kAppointments;
...
- (void)getRepairOrders {
    ...
    mAppDelegate_.mWebEngine_.mWebMethodType_=kGET;
    NSString *mRequestStr=[NSString stringWithFormat:@"%@%@%@/%@?UserID=%@",WEBSERVICEURL,@"Stores/",mAppDelegate_.mModelForSplashScreen_.mStoreID_,mAppDelegate_.mWebEngine_.mWebMethodName_,mAppDelegate_.mModelForSplashScreen_.mEmployeeID_];
    mRequestStr = [mRequestStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    [mAppDelegate_.mWebEngine_ makeRequestWithUrl:mRequestStr requestData:nil];
}
...
- (void)putRequestToUpdateVehicleDetails:(NSString *)aVehicleID
    ...
    NSString *data =[NSString stringWithFormat:@"{\"UserID\":\"%d\",\"Data\":{\"StoreID\":\"%d\",\"MakeID\":\"%d\",\"Make\":\"%@\",\"Model\":\"%@\",\"Year\":\"%@\",\"VIN\":\"%@\",\"Mileage\":\"%d\",\"License\":\"%@\",\"Color\":\"%@\"}}",[mAppDelegate_.mModelForSplashScreen_.mEmployeeID_ intValue],[aStoreID intValue],[aMake intValue],aMake,aModel,aYear,aVIN,[aMileage intValue],aLicense,aColor];
    mRequestStr = [mRequestStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    [mAppDelegate_.mWebEngine_ makeRequestWithUrl:mRequestStr requestData:data];
}
...
- (void)postRequestForCheckin:(NSString *)userID
    ...
    if ([[[[SharedUtilities sharedUtilities] appDelegateInstance] isCustomHeaderViewFullOrLight] isEqualToString:@"FULL"]) {
        data = [NSString stringWithFormat:@"{\"UserID\":\"%d\",\"Data\":{\"AdvisorID\":\"%d\",\"AppointmentNumber\":\"%@\",\"Vehicle\":{\"ID\":\"%@\",\"VIN\":\"%@\",\"Mileage\":\"%d\"},\"Customer\":{\"ID\":\"%@\",\"FirstName\":\"%@\",\"LastName\":\"%@\"},\"TagNumber\":\"%@\"}",[userID intValue],[AdvisorID intValue],mAppDelegate_.mModelForSearchScreen_.mAppointmentNumber_,VehicleID,VIN,[mileage intValue],aCustomerID,aFirstName,aLastName,aTagNumber];
    }else {
        data = [NSString stringWithFormat:@"{\"UserID\":\"%d\",\"Data\":{\"AdvisorID\":\"%d\",\"Vehicle\":{\"ID\":\"%@\",\"VIN\":\"%@\",\"Mileage\":\"%d\"},\"TagNumber\":\"%@\"}",[userID intValue],[AdvisorID intValue],VehicleID,VIN,[mileage intValue],aTagNumber];
    }
    [mAppDelegate_.mWebEngine_ makeRequestWithUrl:mRequestStr requestData:data];
