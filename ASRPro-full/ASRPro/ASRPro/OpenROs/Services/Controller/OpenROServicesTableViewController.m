...
/**
 * instance for previous swiped cell in table
 */
...
//--------------------------------------------------- ************** ------------------------------------------------------
//                                      *** Method to get list of add services  ***
//--------------------------------------------------- ************** ------------------------------------------------------
-(void)getAddServicesList{
    ...
    if(mAppDelegate_.mServiceDataGetter_.mAllServicesArray_==nil)
    {
        ...
        [self pushToAddServicesViewModal];
    }
}

//--------------------------------------------------- ************** ------------------------------------------------------
//                         *** Method to create AddServicesViewController instance  ***
//--------------------------------------------------- ************** ------------------------------------------------------
...
//--------------------------------------------------- ************** ------------------------------------------------------
//                                          *** Add Button Action in table header  ***
//--------------------------------------------------- ************** ------------------------------------------------------
-(void)isAddButtonClicked:(UIButton*)sender{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==0){
        if([mAppDelegate_.mOpenRoServiceDataGetter_.mScheduledServicesArray_  count]>0){
            ...
            [cell.textLabel setText:kNOSERVICESLABEL];
...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(xPos, 10,SERVICE_LABEL_WIDTH_OPENRO-10, 20)];
    ...
    [lTempPayTypeLabel setTextAlignment:NSTextAlignmentCenter];
    [lTempPayTypeLabel setFont:[UIFont regularFontOfSize:15 fontKey:kFontNameHelveticaNeueKey]];
    ...
    [lTempHrsLabel setTextAlignment:NSTextAlignmentCenter];
    [lTempHrsLabel setFont:[UIFont regularFontOfSize:15 fontKey:kFontNameHelveticaNeueKey]];
    ...
    [lTempLaborLabel setTextAlignment:NSTextAlignmentCenter];
    [lTempLaborLabel setBackgroundColor:[UIColor clearColor]];
    [lTempLaborLabel setFont:[UIFont regularFontOfSize:15 fontKey:kFontNameHelveticaNeueKey]];
    ...
    [lTempPartsLabel setTextAlignment:NSTextAlignmentCenter];
    [lTempPartsLabel setFont:[UIFont regularFontOfSize:15 fontKey:kFontNameHelveticaNeueKey]];
    ...
    [lTempPriceeLabel setTextAlignment:NSTextAlignmentCenter];
    [lTempPriceeLabel setFont:[UIFont regularFontOfSize:15 fontKey:kFontNameHelveticaNeueKey]];
    ...
    if(section==0){
        UIButton* lTempAddButton=[[UIButton alloc] initWithFrame:CGRectMake(xPos,5 , 26, 26)];
        [lTempAddButton setImage:kADDSERVICE_IMAGE forState:UIControlStateNormal];
