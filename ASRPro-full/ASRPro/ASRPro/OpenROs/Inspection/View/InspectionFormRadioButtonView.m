...
-(void)addButtonToView{
    InspectionButton* lInspectionGreenButton=[[InspectionButton alloc]initWithFrame:CGRectMake(10, 5, 25, 25)];
    ...
    InspectionButton* lInspectionYellowButton=[[InspectionButton alloc]initWithFrame:CGRectMake(40, 5, 25, 25)];
    ...
    InspectionButton* lInspectionRedButton=[[InspectionButton alloc]initWithFrame:CGRectMake(70, 5, 25, 25)];
