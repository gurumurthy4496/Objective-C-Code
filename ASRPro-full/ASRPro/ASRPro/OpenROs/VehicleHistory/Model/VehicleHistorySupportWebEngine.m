    ...
    if([(NSString *)isSucces intValue] == ASRProOKStatusCode){
        ...
        [[[SharedUtilities sharedUtilities] appDelegateInstance].mSearchDataGetter_.mOpenROListDisplayData_ enumerateObjectsUsingBlock:^(id object, NSUInteger index, BOOL *stop) {
            if ([[object valueForKey:@"RONumber"] isEqualToString:[[[SharedUtilities sharedUtilities] appDelegateInstance] mModelForVehicleHistoryTableView_].mOpenROString_]) {
                ...
                [[[[SharedUtilities sharedUtilities] appDelegateInstance] mMasterViewController_].mOpenROFilterButton_ setTitle:@"All" forState:UIControlStateNormal];
                [[[[SharedUtilities sharedUtilities] appDelegateInstance] mMasterViewController_].mOpenROFilterButton_ setTitle:@"All" forState:UIControlStateSelected];
                [[[[[SharedUtilities sharedUtilities] appDelegateInstance] mMasterViewController_] mOpenROTableView_] onSelectionOfOpenRO:[[SharedUtilities sharedUtilities] appDelegateInstance].mMasterViewController_.mOpenROTableView_.mselectedCustomerindex_];
            }
        }];
    /*    if ([[[[[SharedUtilities sharedUtilities] appDelegateInstance].mSearchDataGetter_.mOpenROListDisplayData_ objectAtIndex:[[SharedUtilities sharedUtilities] appDelegateInstance].mMasterViewController_.mOpenROTableView_.mselectedCustomerindex_] valueForKey:@"CurrentMode"] integerValue] == 3) {
