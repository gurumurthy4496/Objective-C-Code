...
- (IBAction)logoutButtonAction:(id)sender {
    ...
    [[LogoutSupportEngine sharedInstance] postRequestToLogOut];
...
- (void)removeTheCacheData {
    [[[SharedUtilities sharedUtilities] appDelegateInstance] mModelForSplashScreen_].mLoginDataArray_ = nil;
    ...
    [self removeOneFile:kEmployeesData fileInDocumentary:YES];
    [self removeOneFile:kStore_VehicleDiagrams_sets_Array fileInDocumentary:YES];
    [self removeOneFile:kALLSERVICESPACKAGE fileInDocumentary:NO];
    [self removeOneFile:kALLSERVICESPATH fileInDocumentary:NO];
...
//    [[SharedUtilities sharedUtilities] saveDictionaryInToFile:nil :kStore_VehicleDiagrams_sets_Array];
  ...
  [[FileUtils fileUtils] deleteFileFromPath:kPARTSLOCATIONSPATH];
    [[FileUtils fileUtils] deleteFileFromPath:kPAYTYPESPATH];
    ...
    mAppDelegate_.mSearchDataGetter_.mRepairOrdersData_ = nil;
    mAppDelegate_.mSearchDataGetter_.mOpenROListData_ = nil;
    mAppDelegate_.mSearchDataGetter_.mOpenROListDisplayData_ = nil;
    mAppDelegate_.mModelForWalkAround_.mPRE_RONumber = @"";
    mAppDelegate_.mModelForWalkAround_.mTempPRE_RONumber = @"";
}

-(void)removeOneFile:(NSString*)fileName fileInDocumentary:(BOOL)aFileInDocumentary {
    NSFileManager *fileManager = [NSFileManager defaultManager];
    NSArray *paths;
    if (aFileInDocumentary) {
    ...
    if (!aFileInDocumentary) {
        fullPath = [documentsDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"Caches/%@", fileName]];
    }
