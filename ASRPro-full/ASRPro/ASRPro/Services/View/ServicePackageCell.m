...
-(void)addFastMover {
    ...
    UILabel* lTempLabel=[[UILabel alloc] initWithFrame:CGRectMake(30, 10, 260, 20)];
...
-(void)addChildSGID{
    ...
    UILabel* lTempLabel=[[UILabel alloc] initWithFrame:CGRectMake(10, 0, 280, 40)];
