...
- (void)onSuccessForDamageDetails:(NSObject *) isSucces {
    ...
    if([(NSString *)isSucces intValue] == ASRProOKStatusCode) {
        ...
        [[SharedUtilities sharedUtilities] showAlertWithTitle:NSLocalizedString(@"Damage Details", nil) message:NSLocalizedString(@"lERROR_RESPONSE_FROM_SERVER_TEXT", nil)];
    }
}
...
- (void)onSuccessOfPostRequestDamageDetailsImage:(NSObject *) isSucces {
    ...
    if([(NSString *)isSucces intValue] == ASRProOKStatusCode || [(NSString *)isSucces intValue] == ASRProCreatedStatusCode) {
        ...
        [[SharedUtilities sharedUtilities] showAlertWithTitle:NSLocalizedString(@"Damage Details Image", nil) message:NSLocalizedString(@"lERROR_RESPONSE_FROM_SERVER_TEXT", nil)];
    }
}
