...
@interface ModelForWalkAround : NSObject<UIScrollViewDelegate>{
    @public
    BOOL isROChanged;
}
 ...
 */
@property (nonatomic, retain) NSString *mPRE_RONumber;

/**
 * Selected mTempPRE_RONumber.
 */
@property (nonatomic, retain) NSString *mTempPRE_RONumber;
...
@property (nonatomic, assign) float imageStartPositionOnScrollView;
