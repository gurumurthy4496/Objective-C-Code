...
- (void)viewDidLayoutSubviews {
    ...
    mAppDelegate_.mWalkAroundViewController_.mVehicleDiagramsImageView_ = imageView;
    [self.mDamagePopupButton_ setFrame:CGRectMake(imageView.frame.origin.x + mCGPoint_.x  - (self.mDamagePopupButton_.frame.size.width/2) + 13, imageView.frame.origin.y + mCGPoint_.y - self.mDamagePopupButton_.frame.size.height, self.mDamagePopupButton_.frame.size.width, self.mDamagePopupButton_.frame.size.height)];
}
