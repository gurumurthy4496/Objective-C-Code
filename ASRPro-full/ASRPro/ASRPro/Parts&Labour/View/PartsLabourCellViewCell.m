...
-(void)addCurrentServicesCell{
    ...
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempQualityLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[[mAppDelegate_.mPartLabourDataGetter_.mModelForCurrentPart_ getQualityDict:[[mServicesDict objectForKey:kPART_QUALITY_ID] intValue]] objectForKey:kPART_QUALITY]!=nil?[[mAppDelegate_.mPartLabourDataGetter_.mModelForCurrentPart_ getQualityDict:[[mServicesDict objectForKey:kPART_QUALITY_ID] intValue]] objectForKey:kPART_QUALITY]:@"" labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempQuantityLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"%@",[mServicesDict objectForKey:@"Quantity"]!=nil?[mServicesDict objectForKey:@"Quantity"]:@""] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempPartsNumberLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"%@",[mServicesDict objectForKey:@"PartNumber"]!=nil?[mServicesDict objectForKey:@"PartNumber"]:@""] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempLocationLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[[mAppDelegate_.mPartLabourDataGetter_.mModelForCurrentPart_ getLocationDict:[[mServicesDict objectForKey:kPART_LOCATION_ID] intValue]] objectForKey:kPART_LOCATION]!=nil?[[mAppDelegate_.mPartLabourDataGetter_.mModelForCurrentPart_ getLocationDict:[[mServicesDict objectForKey:kPART_LOCATION_ID] intValue]] objectForKey:kPART_LOCATION]:@"" labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    [[GenericFiles genericFiles] createUILabelWithInstance:lTempPriceLabel labelTitleFont:[UIFont regularFontOfSize:14 fontKey:kFontNameHelveticaNeueKey] labelTitle:[NSString stringWithFormat:@"%@",[mServicesDict objectForKey:@"Price"]!=nil?[mServicesDict objectForKey:@"Price"]:@""] labelTextColor:[UIColor blackColor] labelTextAlignment:NSTextAlignmentCenter labelBackgroundColor:[UIColor clearColor]];
    ...
    [lTempEditButton setHidden:showEdit];
